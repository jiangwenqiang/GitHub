...
--3.4	商品条码类型
 ...
 insert into distitem_type(fieldname,type,desp) values('v_type','1','地磅');
...
--4.增加前台权限表
 ...
 insert into right_lst(power_id,name) values(122,'地磅修改');
...
insert into pos_para  (para,val,notes) 
  values ('CASH_MAXLIMIT','10000','钱箱最大现金控制额');
  
insert into pos_para  (para,val,notes) 
  values ('BANK_CARD_TYPE','OFF','是否输入银行卡类型');
  
insert into pos_para (para,val,notes) 
  values ('AUTO_LOCK_TIME','0','设定自动锁机等待时间(毫秒)');
...
-------keybd_class--------------------------------------
insert into keybd_class(classname,note) values('123            ','新键盘                        ');
insert into keybd_class(classname,note) values('I95            ','IBM95键盘图                   ');
insert into keybd_class(classname,note) values('IBM            ','IBM键盘图                     ');
insert into keybd_class(classname,note) values('NCR            ','NCR键盘图                     ');
insert into keybd_class(classname,note) values('TA             ','TA61键盘图                    ');
insert into keybd_class(classname,note) values('W84            ','WINCOR 84键键盘               ');
