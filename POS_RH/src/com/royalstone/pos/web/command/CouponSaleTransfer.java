 ...
 * @author liangxinbiao
 */
public class CouponSaleTransfer implements ICommand {
	...
	public Object[] excute(Object[] values) {
		...
		if (values.length == 3
			...
			try {
                ...
                CouponSaleList payVOs = (CouponSaleList) values[1];
				String host = (String) values[2];
				String result = null;

				result = pay(payVOs,host);
  ...
  private String pay(CouponSaleList payVo,String host){
      String result = null;
		...
		try {
			...
			params[0] = "com.royalstone.pos.web.command.CouponSaleServletCommand";
			params[1] = payVo;
  ...
  private String pay(CouponSale[] payVos,String host){
      String result = null;
		...
		try {
			...
			params[0] = "com.royalstone.pos.web.command.CouponsSaleCommand";
			params[1] = payVos;
