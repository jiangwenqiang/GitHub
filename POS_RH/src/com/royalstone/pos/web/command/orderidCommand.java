...
import com.royalstone.pos.web.util.DBConnection;
	 ...
	 *
	 */
	public class orderidCommand implements ICommand 
	{

		public Object[] excute(Object[] values) {
			System.out.println( "orderidCommand executed!" );
			...
			if ( values != null && values.length >1 ) {
				...
				try {
					...
					Operator orderid=minister.getOrderid(posid);
					int id = 0;
					if ( orderid.getorderid() == id ){
						Operator orid = minister.setOrderid(posid);
						response = new Response(orid);
						}
					else{
						response = new Response(orderid);
						}
