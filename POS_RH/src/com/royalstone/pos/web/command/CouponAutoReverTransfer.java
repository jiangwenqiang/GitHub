 ...
 * @author liangxinbiao
 */
public class CouponAutoReverTransfer implements ICommand {
  ...
  private String pay(CouponSaleList couponSales,String host){
      String result = null;
		...
		try {
			...
			params[0] = "com.royalstone.pos.web.command.CouponAutoReverServletCommand";
