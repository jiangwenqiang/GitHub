...
public class ShoppingCardConfirm
  ...
  JLabel RHcardBalance = new JLabel();//荣华币余额
  ...
  JLabel jLabel17 = new JLabel(); //荣华币
...
//		this.setLocation(280, 150);
	...
	public void setButton(String value) {
        this.enterButton.setText(value);
    }
	...
	private void jbInit() throws Exception {
		...
		enterButton.setPreferredSize(new Dimension(140, 30));
	...
	public static void main(String[] args) {
		...
		shoppingCardConfirm.setCardAmount("233.22 = 122.33");
